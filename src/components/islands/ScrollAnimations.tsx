...
export default function ScrollAnimations() {
  useEffect(() => {
    ...
    (async () => {
      ...
      // Integração GSAP ScrollTrigger com Lenis (padrão oficial da lib):
      // o ScrollTrigger acompanha o evento "scroll" do Lenis e o Lenis é
      // avançado pelo ticker do GSAP, um loop só.
